...
test-lint-python:  ## Compile-check Python scripts
	...
	python3 -m py_compile bin/dashboard-sync.py scripts/reverse-engineer-codex-pricing.py scripts/export-codex-otel-audit.py scripts/export-claude-otel-audit.py scripts/backfill-codex-normalized.py
	@echo "OK"
